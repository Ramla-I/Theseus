...
impl Buffer {
    #[inline(always)]
    pub fn get_ref(&self) -> &EthernetFrame {
        unsafe{ & *((self.vaddr & !0x7FF) as *const EthernetFrame)}
    }

    #[inline(always)]
    pub fn get_ref_mut(&mut self) -> &mut EthernetFrame {
        unsafe{ &mut *((self.vaddr & !0x7FF) as *mut EthernetFrame)}
    }

    #[inline(always)]
    pub fn get_length(&self) -> u16 {
        (self.vaddr & 0x7FF) as u16
    }

    #[inline(always)]
    pub fn set_length(&mut self, length: u16) {
        self.vaddr = (self.vaddr & !0x7FF) | length as usize;
    }
}
